package com.ly.tinycalendar.utils;
...
public class CalendarUtil {
    ...
    public static long dateToMillis(int[] date) {
        ...
        calendar.set(date[0], date[1]-1, day);//月份要设置正确，最多买到2019.2.2号 对应到月份是1而不能是2（2019年3月2号之内都可以买票），2019。1.31对应的月份是0，而不能是1(2019年2月31==2019年3月3号，不可买票！！！)

        long mills = calendar.getTimeInMillis();
        return mills;
    }

//    public static long dateToMillisEnd(int[] date) {
//        int day = date.length == 2 ? 1 : date[2];
//        Calendar calendar = Calendar.getInstance();
//
//        calendar.set(date[0], date[1]-1, day);//月份要设置正确，最多买到2019.2.2号 对应到月份是1而不能是2（2019年3月2号之内都可以买票），2019。1.31对应的月份是0，而不能是1(2019年2月31==2019年3月3号，不可买票！！！)
